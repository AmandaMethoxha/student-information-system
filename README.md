...
> Add images to `/docs/images/` and link them here. Examples below:

| Screen                                                | Description                                          |
| ----------------------------------------------------- | ---------------------------------------------------- |
| ![Home](docs/images/home.png)                         | Role selection: Staff / Student                      |
| ![Staff Login](docs/images/staff-login.png)           | Secure staff sign‑in                                 |
| ![Dashboard](docs/images/dashboard.png)               | Quick actions: Students, Courses, Scores, Statistics |
| ![Register Student](docs/images/register-student.png) | Create a new student with personal details           |
| ![Statistics](docs/images/statistics.png)             | Performance, gender, nationality insights            |

Optional: add a short demo video/GIF in `/docs/demo/` and link it here.
...
└─ docs/                                # README assets (images, demo)
```
...
This project is licensed under the **MIT License** — see [`LICENSE`](LICENSE) for details. (Or replace with your preferred license.)
